      ...
      [
        {
          ...
          date: new Date(Date.UTC(2023, 1, 14)),
        },
        {
          name: "День всех влюбленных",
          date: new Date(Date.UTC(2023, 2, 14)),
        },
        {
          name: "День защитника Отечества",
          date: new Date(Date.UTC(2023, 2, 23)),
        },
        {
          name: "Международный женский день",
          date: new Date(Date.UTC(2023, 3, 8)),
        },
        {
        ...
        },
        {
          ...
          date: new Date(Date.UTC(2023, 6, 2)),
        },
        {
          name: "День программиста",
          date: new Date(Date.UTC(2023, 9, 13)),
        },
        {
          name: "День интернета",
          date: new Date(Date.UTC(2023, 9, 30)),
        },
        {
          name: "День Ежа!",
          date: new Date(Date.UTC(2023, 2, 2)),
        },
        {
          name: "День пьяного Ежа!",
          date: new Date(Date.UTC(2023, 11, 28)),
        },
        {
